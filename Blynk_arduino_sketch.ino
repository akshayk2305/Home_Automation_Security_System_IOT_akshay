...
#define BLYNK_TEMPLATE_ID "TMPL3NdwKb3ft"
#define BLYNK_TEMPLATE_NAME "Full Home Automation System"
#define BLYNK_AUTH_TOKEN "ROfGp-B8YIBPXwSfqkiQw0S1uGV0vkxI"
...
char auth[] = "ROfGp-B8YIBPXwSfqkiQw0S1uGV0vkxI";//Enter your Auth token
char ssid[] = "LC";//Enter your WIFI name
char pass[] = "lc@tiet1";//Enter your WIFI password
